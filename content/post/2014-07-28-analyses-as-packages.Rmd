...
Instead of writing an analysis as a single or set of `R` scripts, use a `package` and include the analysis as a `vignette` of the package. Read below for the why, the [how is in the next post](/post/vignette-analysis).

---
title: Narrower Kable Tables
author: Robert M Flight
date: '2019-11-06'
slug: narrower-kable-tables
categories: []
tags:
  - R
  - knitr
...
Don't bother trying to roll your own function to make narrower `kable` tables, just use [`kableExtra`](https://cran.r-project.org/web/packages/kableExtra/index.html).
